...
In future production environments, the backend server must be managed using the PM2 process manager to ensure zero-downtime clustering and automated crash recoveries:
\begin{verbatim}
...
\section*{Appendix I: Raw Scraper Payload Samples}
...
\subsection*{I.1 Checkpoint Scraper Raw Payload Example}
\begin{verbatim}
event: threat
data: {
  "srcIp": "194.26.135.8",
...
\subsection*{I.2 Bitdefender Scraper Raw Payload Example}
\begin{verbatim}
{
  "event": "detection",
  "channel": "ransomware",
...
\subsection*{I.3 Fortinet Scraper Raw Payload Example}
\begin{verbatim}
[
  {
    "srcCountry": "Germany",
...
\subsection*{I.4 URLhaus Malware Scraper Raw Payload Example}
\begin{verbatim}
{
  "query_status": "ok",
  "urls": [
...
\subsection*{I.5 Kaspersky Feodo Botnet Tracker Raw Payload Example}
\begin{verbatim}
# Firstseen,DstIP,DstPort,Malware,Asname
2026-05-21,103.5.8.12,443,Qakbot,Chinanet,Active
\end{verbatim}

\subsection*{I.6 AlienVault OTX Pulse Scraper Raw Payload Example}
\begin{verbatim}
{
  "count": 1,
  "results": [
...
\subsection*{I.7 Ransomwatch Extortion Scraper Raw Payload Example}
\begin{verbatim}
[
  {
    "group": "LockBit 3.0",
...
\subsection*{I.8 MontySecurity C2 Tracker Raw Payload Example}
\begin{verbatim}
[
  {
    "ip": "185.220.101.9",
...
\subsection*{I.9 MISP Galaxy Synthetic Scraper Raw Payload Example}
...
\subsection*{I.10 SANS ISC DShield Raw Payload Example}
\begin{verbatim}
[
  {
    "ip": "185.220.101.5",
...
\section*{Appendix J: Sample STIX 2.1 Threat Ingestion Bundle}
...
\section*{Appendix K: Pre-allocated Circular Memory Buffer \\ (\texttt{RingBuffer.ts})}
...
\section*{Appendix L: Browser-Side FPS Telemetry Hook \\ (\texttt{useFpsTelemetry.ts})}
...
\section*{Appendix M: STIX Parser and Classification Utilities}
...
\subsection*{M.1 STIX 2.1 Object separation and MITRE compiler}
\begin{verbatim}
...
\subsection*{M.2 Regex-based Indicator Classification}
\begin{verbatim}
