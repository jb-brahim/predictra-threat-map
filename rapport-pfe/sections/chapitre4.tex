...
\begin{tikzpicture}[node distance=2cm, scale=0.85, every node/.style={transform shape}]
    ...
    % Actors
    \node[draw=charcoal, fill=cyberblue!10, thick, minimum width=2.2cm, minimum height=1cm, align=center] (analyst) at (-2.5, 0) {\textbf{Security}\\\textbf{Analyst}};

    % Use Cases
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc1) at (4.25, 2) {Upload STIX 2.1 Bundle};
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc2) at (4.25, 0.7) {Analyze MITRE Kill Chain};
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc3) at (4.25, -0.6) {Navigate Relationship Graph};
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc4) at (4.25, -1.9) {Filter Indicator IOCs};
...
\begin{tikzpicture}[scale=0.85, every node/.style={transform shape}]
    % StixDashboard Page
    \node[draw, rectangle, fill=cyberblue!5, text width=6.5cm, align=left] (stixDash) at (0,0) {
    ...
    % StixVisualizerPage
    \node[draw, rectangle, fill=cyberblue!5, text width=6.2cm, align=left] (stixVis) at (9,0) {
...
\begin{tikzpicture}[scale=0.85, every node/.style={transform shape}]
    ...
    % Headers
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (0,0.3) {Analyst};
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (3.8,0.3) {Dashboard};
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (7.5,0.3) {Parser Service};
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (11.2,0.3) {D3 Canvas};
...
\begin{tikzpicture}[node distance=2cm, scale=0.85, every node/.style={transform shape}]
    ...
    % Use Cases
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc1) at (4.25, 1.5) {Search History Logs};
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc2) at (4.25, 0) {Trigger Target My IP};
    \node[draw, ellipse, fill=white, minimum width=3.8cm, minimum height=0.8cm] (uc3) at (4.25, -1.5) {Monitor Performance HUD};
...
\begin{tikzpicture}[scale=0.85, every node/.style={transform shape}]
    % HistoryPage Page
    \node[draw, rectangle, fill=cyberblue!5, text width=6.8cm, align=left] (history) at (0,0) {
    ...
    % RingBuffer Class
    \node[draw, rectangle, fill=cyberblue!5, text width=5.5cm, align=left] (ring) at (8.5,0) {
...
\begin{tikzpicture}[scale=0.85, every node/.style={transform shape}]
    ...
    % Headers
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (0,0.3) {Analyst};
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (3.8,0.3) {History UI};
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (7.5,0.3) {Express Server};
    \node[draw, fill=cyberblue!10, minimum width=2.2cm, minimum height=0.6cm] at (11.2,0.3) {MongoDB};
