...
\begin{tikzpicture}[node distance=2.2cm, scale=0.85, every node/.style={transform shape}]
    ...
    % Actors
    \node[draw=charcoal, fill=cyberblue!10, thick, minimum width=2.2cm, minimum height=1cm, align=center] (api) at (-3, 2) {\textbf{External Threat}\\\textbf{APIs \& Feeds}};
    \node[draw=charcoal, fill=cyberblue!10, thick, minimum width=2.2cm, minimum height=1cm, align=center] (analyst) at (-3, -2) {\textbf{Security}\\\textbf{Analyst}};
    \node[draw=charcoal, fill=cyberblue!10, thick, minimum width=2.2cm, minimum height=1cm, align=center] (db) at (12.5, 0) {\textbf{MongoDB}\\\textbf{Database}};

    % Use Cases inside Boundary
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc1) at (4.75, 4) {Stream Live Threat Events};
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc2) at (4.75, 2.5) {Enrich \& Geocode Log};
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc3) at (4.75, 1) {Render 3D Interactive Map};
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc4) at (4.75, -0.5) {Query Historical Log};
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc5) at (4.75, -2) {Export to Excel / CSV};
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc6) at (4.75, -3.5) {Upload STIX 2.1 Bundle};
    \node[draw, ellipse, fill=white, minimum width=4cm, minimum height=0.9cm, align=center] (uc7) at (4.75, -5) {Explore Threat Network Graph};
...
\begin{tikzpicture}[
    ...
    component/.style={draw=charcoal, fill=cyberblue!5, thick, rectangle, minimum width=3.8cm, minimum height=1cm, align=center, font=\small},
...
\begin{tikzpicture}[
    node distance=1.5cm,
    layer/.style={rectangle, draw=charcoal, fill=charcoal!5, thick, rounded corners, minimum width=12.2cm, text width=11.8cm, minimum height=1.2cm, align=center},
