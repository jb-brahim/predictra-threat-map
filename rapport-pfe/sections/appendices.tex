...
\section*{Appendix K: Pre-allocated Circular Memory Buffer (RingBuffer.ts)}
...
\section*{Appendix L: Browser-Side FPS Telemetry Hook (useFpsTelemetry.ts)}
...
\section*{Appendix N: D3 Force-Directed Canvas Rendering}
