...
\begin{tikzpicture}[
    ...
    every node/.style={draw=charcoal, fill=cyberblue!10, thick, rounded corners, align=center, minimum width=3.8cm, minimum height=1cm, font=\small}
]
...
\begin{tikzpicture}[
    node distance=1.2cm,
    box/.style={draw=charcoal, fill=cyberblue!5, thick, rounded corners, minimum width=3.8cm, minimum height=0.8cm, align=center, font=\small},
