...
\begin{figure}[h!]
    ...
    \caption{The 3D Live Threat Map showing active threat corridors and origin/destination coordinates.}
...
\begin{figure}[h!]
    ...
    \caption{The System Dashboard displaying active feed metrics and high-severity threat summaries.}
...
\begin{figure}[h!]
    ...
    \caption{The STIX 2.1 Workspace displaying an uploaded threat bundle and its network representation.}
    \label{fig:ui_stix}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{The Historical Threat Browser with paginated data tables and advanced filtering capabilities.}
...
\begin{figure}[h!]
    ...
    \caption{The Analytics Dashboard presenting aggregate threat metrics and sector distributions.}
